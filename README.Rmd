...
Square fill colours can be specified with the `palette` argument. See `plot_fen()` documentation for more details. An attempt at newspaper style can be set using `palette = "news"`
```{r}
